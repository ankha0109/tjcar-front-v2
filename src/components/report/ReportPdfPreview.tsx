        ...
        <>
          ...
          <div className="mt-3 flex gap-3">
            <div className="grid h-16 w-24 shrink-0 place-items-center rounded-md bg-neutral-100 dark:bg-neutral-800">
              <svg
                viewBox="0 0 48 20"
                className="h-7 w-16 text-neutral-300 dark:text-neutral-600"
                fill="currentColor"
              >
      ...
      return (
        <>
          ...
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="mt-2.5 rounded-md border border-neutral-200 p-2 dark:border-neutral-700"
            >
      ...
      return (
        <>
          ...
          <div className="mt-3 rounded-md border border-neutral-200 p-2.5 dark:border-neutral-700">
            ...
            <svg
              viewBox="0 0 120 44"
              className="mt-2 w-full text-neutral-300 dark:text-neutral-600"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.6"
            >
    ...
    case "verify":
      return (
        <>
          ...
          <p className="mt-2.5 text-center text-[8px] text-neutral-500 dark:text-neutral-400">
            TJ-2607-0042
          </p>
      ...
      <div className="relative aspect-[210/260] overflow-hidden rounded-xl border border-neutral-200 bg-white p-3.5 shadow-[0_24px_50px_-30px_rgba(0,0,0,0.35)] transition-transform duration-300 hover:-translate-y-1 dark:border-neutral-700 dark:bg-neutral-900">
        {page.image ? (
          <Image
            ...
            unoptimized={
              typeof page.image === "string" && page.image.endsWith(".svg")
            }
