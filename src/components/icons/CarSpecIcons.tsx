...
import type { ColorSwatch } from "@/utils/carColor";
...
/** Duotone fuel-pump glyph for the fuel / engine-type quick-spec tile. */
export function FuelIcon({ size = 20, className }: SpecIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M14 7H17V4C17 3 18 3 19 3H20V14H18V12"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
/**
 * Duotone document-and-pen glyph for the first-registration (Анх бүртгэсэн)
 * quick-spec tile.
 */
export function RegistrationIcon({ size = 20, className }: SpecIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        opacity="0.14"
        d="M4.21799 4.09202C4 4.51984 4 5.0799 4 6.2V17.8C4 18.9201 4 19.4802 4.21799 19.908C4.40973 20.2843 4.71569 20.5903 5.09202 20.782C5.51984 21 6.0799 21 7.2 21H16.8C17.9201 21 18.4802 21 18.908 20.782C19.2843 20.5903 19.5903 20.2843 19.782 19.908C20 19.4802 20 18.9201 20 17.8V14.6767L15.795 18.8816C15.2837 19.393 15.028 19.6487 14.7366 19.8516C14.4779 20.0318 14.1989 20.1807 13.9053 20.2953C13.5745 20.4244 13.2198 20.4945 12.5104 20.6347L11.1956 20.8946L11.5136 19.5417C11.6687 18.8821 11.7462 18.5522 11.8752 18.2447C11.9898 17.9717 12.1342 17.7123 12.306 17.4712C12.4995 17.1996 12.7391 16.96 13.2183 16.4809L18.4547 11.2444C18.8752 10.824 19.4555 10.6608 20 10.7548V6.2C20 5.0799 20 4.51984 19.782 4.09202C19.5903 3.71569 19.2843 3.40973 18.908 3.21799C18.4802 3 17.9201 3 16.8 3H7.2C6.0799 3 5.51984 3 5.09202 3.21799C4.71569 3.40973 4.40973 3.71569 4.21799 4.09202Z"
        fill="currentColor"
      />
      <path
...
/** Duotone car-seat glyph for the seat-count quick-spec tile. */
export function SeatIcon({ size = 20, className }: SpecIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M8 2H14C15 2 15.5 2.5 15.5 3.5V5.5C15.5 6.5 15 7 14 7H8C7 7 6.5 6.5 6.5 5.5V3.5C6.5 2.5 7 2 8 2Z"
        fill="currentColor"
        fillOpacity="0.14"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      />
      <path
        d="M6 7H16C17 7 17.5 7.5 17.5 8.5V15C17.5 16 17 16.5 16 16.5H6C5 16.5 4.5 16 4.5 15V8.5C4.5 7.5 5 7 6 7Z"
        fill="currentColor"
        fillOpacity="0.14"
        stroke="currentColor"
        strokeWidth="1.5"
      ...
      />
      <path
        d="M5 16.5H19C20 16.5 20.5 17 20.5 18V19C20.5 20 20 20.5 19 20.5H5C4 20.5 3.5 20 3.5 19V18C3.5 17 4 16.5 5 16.5Z"
        fill="currentColor"
        fillOpacity="0.14"
        stroke="currentColor"
        strokeWidth="1.5"
...
/**
 * The colour tile's "icon" — a filled circle showing the car's actual paint
 * rather than a glyph. Sized to sit in the same 20px box as its neighbours.
 */
export function ColorIcon({ swatch }: { swatch: ColorSwatch }) {
  return (
    <span
      aria-hidden
      className={cn(
