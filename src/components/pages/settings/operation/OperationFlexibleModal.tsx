...
const OperationFlexibleModal = ({
  ...
  const handleCreate = () => {
    form
      ...
      .then(async (values) => {
        setSaving(true);
        await Api.post("/roster/flexible", values)
          .then(() => {
            message.success("Цагийн бүртгэл нэмэгдлээ");
            setOpen(false);
            refetch();
          })
          .catch((err) => {
  ...
  const handleDelete = () => {
    confirm({
      ...
      description: "Цагийн бүртгэлийг устгах уу?",
      onOk: () => {
        Api.delete(`/roster/flexible/${updateData?.id}`)
          .then(() => {
            message.success("Цагийн бүртгэл устгагдлаа");
            setOpen(false);
            form.resetFields();
            refetch();
          })
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-5">
          <div className="grid grid-cols-[80px_1fr_1fr_1fr] gap-y-3 gap-4 items-center">
            <div></div>
            <div className="text-secondary">Өдөрт ажиллах цаг</div>
            <div className="text-secondary">А/эхлэх сүүлийн цаг</div>
                        ...
                        {isWork ? (
                          ...
                          <div className="col-span-3">
                            <Input
                              value="Амарна"
                              readOnly
                              className="bg-link-water border-transparent focus:shadow-none"
                            />
                          </div>
                        )}
                      </Fragment>
...
export default OperationFlexibleModal;
