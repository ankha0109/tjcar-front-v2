...
export default async function JapanPage({ searchParams }: PageProps) {
  ...
  if (carsResult.status === "rejected") {
    console.error("[Japan] /featured fetch failed:", carsResult.reason);
  }
  ...
  if (optionsResult.status === "rejected") {
    console.error(
      "[Japan] /filter-options fetch failed:",
